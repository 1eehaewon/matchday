    ...
    <div class="col-sm-12 text-center">
        ...
        <form name="videofrm" id="videofrm" method="post" action="insert">
            <table class="table table-hover">
                ...
                <tr>
                    <td>하이라이트 이름</td>
                    <td> <input type="text" name="video_name" value="${detail.video_name}" class="form-control"> </td>
                </tr>
                <tr>
                    <td>하이라이트 주소</td>
                    <td>
                ...
                <tr>
                    <td>하이라이트 내용</td>
                    <td> <input type="text" name="description" value="${detail.description}" class="form-control"> </td>
                </tr>
                <tr>
  	...
  	$("#commentInsertBtn").click(function(){
		  ...
		  if(content.length==0) {
			  //alert("댓글 내용 입력해주세요~");
  			  ...
  			  //let params = "video_code=" + $("#video_code").val() + "&content=" + $("#content").val();
