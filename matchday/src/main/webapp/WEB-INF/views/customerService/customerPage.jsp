...
$(document).ready(function() {
    ...
    const inquiryTableBody = $('#inquiryTableBody');
    ...
    $('#passwordModal').on('show.bs.modal', function(event) {
        ...
        // 회원 등급이 'M'인 경우 비밀번호 입력 모달을 우회하고 바로 페이지로 이동합니다.
        if (userGrade === 'M') {
...
function searchCheck() {
    var word = $('#word').val(); // 검색어 입력 필드의 값을 가져옵니다.
    if (word.trim() === '') { // 검색어가 비어있는지 확인합니다.
        $('#word').prop('disabled', true); // 검색어 입력 필드를 비활성화합니다.
    }
