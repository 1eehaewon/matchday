        ...
        <c:if test="${not empty goods}">
            <div class="product-section"> <!-- 사진+글 -->
                ...
                <div class="product-info"> <!-- 글 -->
                    <div class="product-title">${goods.productname} (상품명)</div>
                    	
                    <div class="product-price">
                        (가격)<fmt:formatNumber value="${goods.price}" pattern="#,###원"/>
                    </div>
                    ...
                    <!-- 관리자용 상품 수정, 상품 삭제 -->
                    <br>
                    <form name="goodsfrm" method="post" enctype="multipart/form-data" action="detailupdate.jsp">
