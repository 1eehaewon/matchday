...
<main>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form name="playerfrm" id="playerfrm" method="post" action="insert" enctype="multipart/form-data">
                <table class="table table-striped">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2" class="text-center"><input type="submit" value="선수 정보 등록" class="btn btn-success"></td>
                        </tr>
                    </tbody>
                </table>
            </form>
